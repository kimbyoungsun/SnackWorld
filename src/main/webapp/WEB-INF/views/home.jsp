...
<section id="content">
	...
	<a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=a003f65c12b4522d355e7a970a515794&redirect_uri=http://localhost/mvc/member/enroll/kakao">
		<img src="${path}/resources/images/kakao_login_medium_narrow.png" >
	</a>
	<br>
	
	<h3>로그인</h3>
	<a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=a003f65c12b4522d355e7a970a515794&redirect_uri=http://localhost/mvc/kakaoLogin">
